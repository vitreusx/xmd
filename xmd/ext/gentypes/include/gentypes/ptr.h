...
#define GEN_PTR_3(name, T1, x1)                                                \
  ...
  public:                                                                      \
    ...
    inline name##_ptr(name NO_SPEC() * ptr_)                                   \
        :                                                                      \
                                                                               \
          x1##_ptr{ref_to_ptr(ptr_->x1())}                                     \
                                                                               \
          {};                                                                  \
                                                                               \
    inline name##_ref NO_SPEC() operator*() const {                            \
      return {                                                                 \
                                                                               \
          *x1##_ptr                                                            \
                                                                               \
  ...
  LEAVE_NS()                                                                   \
                                                                               \
  NO_TEMPLATE()                                                                \
  inline NS_PREFIX() name##_ptr NO_SPEC()                                      \
