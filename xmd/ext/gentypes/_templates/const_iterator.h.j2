...
public:
    ...
    const_iterator operator++(int) const {
        return const_iterator(data_, idx_++);
    }
    ...
    friend Idx operator-(const_iterator const& iter1, const_iterator const& iter2) {
    ...
    const_ref<T> operator[](Idx idx) const {
        return data_[idx];
    }
    ...
    friend bool operator<(const_iterator const& iter1, const_iterator const& iter2) {
        return iter1.idx_ < iter2.idx_;
    }
